...
<div id="main" class="main"> 
  ...
  <div id="erweima">
    <p><c:choose>
			<c:when test="${product != null}">
				<img src="<c:url value='/image/QRCode/${product.productName}'></c:url>" width="182" height="184" alt="">
			</c:when>
		</c:choose>
	</p>
    <span class="close_box" onClick="hideerweima()">关闭窗口</span> </div>
  <!----> 
  <!---->
  <div id="aboutus">
    <h1>关于我们</h1>
    <p>关于数字模创</p>
    <span class="close_box" onClick="hideaboutus()">关闭窗口</span> </div>
  <!----> 
  <!---->
  <div id="describe">
    <h1>简介描述</h1>
    ...
    <span class="close_box" onClick="hidedescribe()">关闭窗口</span> </div>
  <!--
  <div id="switch_bg">
    <ul>
  ...
  -->
  <audio id="music_list" src="../images/gaoshan.mp3" preload="auto" loop></audio>
  <!----> 
  ...
  <div class="menu">
    <ul>
      <li onClick="showdescribe()" class="my_rotate"><span class="icon iconfont">&#xe638;</span></li>
    </ul>
  </div>
  <!----> 
  <!--下面是放置图片的位置-->
